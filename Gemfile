...
#`bundle install` or simply `bundle` in your terminal in the root of the project
#You don't need to use `require 'rails'` or use `require` for any other gem
#defined in this Gemfile because bundler is going to automatically require all
#the gems defined in this file (the gemfile)
...
#`gemfile.lock` directly (unless there is a git conflict)

#if you have the gem installed in your ruby it will just be used, otherwise
#bundler will install that gem for you. `$ bundle`
